...
cvar = _HySpexLibrary.cvar
HYSPEX_FILE_HEADER_VERSION = cvar.HYSPEX_FILE_HEADER_VERSION
...
class ImageCallback(object):
    ...
    def __init__(self):
        if self.__class__ == ImageCallback:
            ...
            _self = self
        _HySpexLibrary.ImageCallback_swiginit(self, _HySpexLibrary.new_ImageCallback(_self, ))
    def __disown__(self):
        self.this.disown()
...
def image_callback_wrapper(a_handle, a_options, a_image, a_handler):
    return _HySpexLibrary.image_callback_wrapper(a_handle, a_options, a_image, a_handler)
class Camera(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    def stopMovingAverageBackgroundCalculation(self, a_timeoutMs=0):
        return _HySpexLibrary.Camera_stopMovingAverageBackgroundCalculation(self, a_timeoutMs)
    ...
    def stopCalculatingBackground(self):
        return _HySpexLibrary.Camera_stopCalculatingBackground(self)
    ...
    def getEventOutputDivisionFactor(self, a_divisionFactor):
        return _HySpexLibrary.Camera_getEventOutputDivisionFactor(self, a_divisionFactor)

    def getSpatialROISupport(self, a_divisibleBy=None):
        return _HySpexLibrary.Camera_getSpatialROISupport(self, a_divisibleBy)
    ...
    def getPendingSpatialROI(self, a_spatialStart, a_spatialSize):
        return _HySpexLibrary.Camera_getPendingSpatialROI(self, a_spatialStart, a_spatialSize)

    def getSpatialROI(self, a_spatialStart, a_spatialSize):
        return _HySpexLibrary.Camera_getSpatialROI(self, a_spatialStart, a_spatialSize)

    def resetSpatialROI(self):
        return _HySpexLibrary.Camera_resetSpatialROI(self)

    def getSpectralROISupport(self, a_maxRegions=None, a_divisiblyBy=None):
        return _HySpexLibrary.Camera_getSpectralROISupport(self, a_maxRegions, a_divisiblyBy)
    ...
    def getParameter(self, *args):
        return _HySpexLibrary.Camera_getParameter(self, *args)
    ...
    def registerNotificationCallback(self, *args):
        return _HySpexLibrary.Camera_registerNotificationCallback(self, *args)

    def unregisterNotificationCallback(self, *args):
        return _HySpexLibrary.Camera_unregisterNotificationCallback(self, *args)

    def registerImageCallback(self, a_func, a_options, a_handle):
        return _HySpexLibrary.Camera_registerImageCallback(self, a_func, a_options, a_handle)

    def unregisterImageCallback(self, a_func):
        return _HySpexLibrary.Camera_unregisterImageCallback(self, a_func)
...
class Logger(object):
    ...
    def registerCallback(self, a_func, a_userData):
        return _HySpexLibrary.Logger_registerCallback(self, a_func, a_userData)

    def unregisterCallback(self, a_func):
        return _HySpexLibrary.Logger_unregisterCallback(self, a_func)
...
class Recorder(object):
    ...
    def __init__(self, a_legacyMode=True):
        _HySpexLibrary.Recorder_swiginit(self, _HySpexLibrary.new_Recorder(a_legacyMode))
