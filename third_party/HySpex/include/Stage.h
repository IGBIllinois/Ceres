...
namespace hyspex
{
    ...
    */
    ...
    public:
        ...
        HYSPEXLIBRARY_API ReturnCode getMoveStatus( bool* a_moving, bool* a_targetSpeedReached ); //!< check if stage is moving and if target speed is reached. NB: signature might change in the future
