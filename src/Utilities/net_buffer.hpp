...
public:
    ...
    //@{
        ...
        net_buffer& operator>>(char& out);
        net_buffer& operator>>(int8_t& out);
        net_buffer& operator>>(uint8_t& out);
        net_buffer& operator>>(int16_t& out);
        net_buffer& operator>>(uint16_t& out);
        net_buffer& operator>>(int32_t& out);
        net_buffer& operator>>(uint32_t& out);
        net_buffer& operator>>(int64_t& out);
        net_buffer& operator>>(uint64_t& out);
        net_buffer& operator>>(float& out);
        net_buffer& operator>>(double& out);
    ...
    //@{
        ...
        net_buffer& operator<<(const char in);
        net_buffer& operator<<(const int8_t in);
        net_buffer& operator<<(const uint8_t in);
        net_buffer& operator<<(const int16_t in);
        net_buffer& operator<<(const uint16_t in);
        net_buffer& operator<<(const int32_t in);
        net_buffer& operator<<(const uint32_t in);
        net_buffer& operator<<(const int64_t in);
        net_buffer& operator<<(const uint64_t in);
        net_buffer& operator<<(const float in);
        net_buffer& operator<<(const double in);
...
public:
    ...
    //@{
        ...
        net_buffer_view& operator>>(char& out);
        net_buffer_view& operator>>(int8_t& out);
        net_buffer_view& operator>>(uint8_t& out);
        net_buffer_view& operator>>(int16_t& out);
        net_buffer_view& operator>>(uint16_t& out);
        net_buffer_view& operator>>(int32_t& out);
        net_buffer_view& operator>>(uint32_t& out);
        net_buffer_view& operator>>(int64_t& out);
        net_buffer_view& operator>>(uint64_t& out);
        net_buffer_view& operator>>(float& out);
        net_buffer_view& operator>>(double& out);
