...
//	const static double PI = 2.0 * std::asin(+1.0);
	...
	constexpr static double FT_TO_IN = 12;
	...
	constexpr static double IN_TO_M = IN_TO_FT * FT_TO_M;
	constexpr static double M_TO_IN = 1.0 / IN_TO_M;

	constexpr static double IN_TO_MM = IN_TO_M * M_TO_MM;
