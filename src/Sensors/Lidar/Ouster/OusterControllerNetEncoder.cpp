...
void cOusterControllerNetEncoder::sendLidarModeMessage(ouster::eLIDAR_MODE mode)
{
...
void cOusterControllerNetEncoder::sendAzimuthWindowMessage(double min_deg, double max_deg)
{
    encode_azimuth_window(min_deg, max_deg, mBuffer);
    sendData();
}

void cOusterControllerNetEncoder::sendCurrentStateMessage(bool valid,
