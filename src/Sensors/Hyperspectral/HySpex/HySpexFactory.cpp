...
sSensorWidgets create_vnir_3000N_sensor(const nlohmann::json& sensorInfo, bool no_visualization)
{
    ...
    if (no_visualization)
    {
        ...
        QObject::connect(pController, &cHySpexCamera_Controller::queryShutterState, pModel, &cHySpexCameraModel::shutterStateQueried);

        QObject::connect(pController, &cHySpexCamera_Controller::setAcquisitionParameters, pModel, &cHySpexCameraModel::requestAcquisitionParameters);
