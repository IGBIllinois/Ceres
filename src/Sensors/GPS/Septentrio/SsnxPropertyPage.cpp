...
cSsnxPropertyPage::cSsnxPropertyPage(QWidget* parent)
	: cSensorPropertyPage(parent)
{}

cSsnxPropertyPage::cSsnxPropertyPage(const std::string& instance, QWidget* parent)
	: cSensorPropertyPage(instance, parent)
{}

void cSsnxPropertyPage::createWidgets()
{
	/** Acquisition Info */
...
//	connect(mpDoBackground, &QPushButton::clicked, this, &cGpsPropertyPage::doCalcBackground);
	connect(mpDoReference, &QPushButton::pressed, this, &cSsnxPropertyPage::doCalcReference);
...
void cSsnxPropertyPage::doLayout()
{
	QLabel* text = nullptr;
...
QGroupBox* cSsnxPropertyPage::getReferenceLayout()
{
