...
//	connect(mpDoBackground, &QPushButton::clicked, this, &cGpsPropertyPage::doCalcBackground);
	connect(mpDoBackground, &QPushButton::pressed, this, &cGpsPropertyPage::doCalcBackground);
}

QGroupBox* cGpsPropertyPage::getLensLayout()
{
...
QGroupBox* cGpsPropertyPage::getAcquisitionLayout()
{
...
QGroupBox* cGpsPropertyPage::getBackgroundLayout()
{
