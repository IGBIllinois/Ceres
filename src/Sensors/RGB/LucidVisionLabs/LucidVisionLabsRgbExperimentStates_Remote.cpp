...
#include "LucidVisionLabsRgbExperimentStates_Remote.hpp"
...
/***********************************************************************************/
cLucidVisionLabsRgbCameraExperimentState_Remote::cLucidVisionLabsRgbCameraExperimentState_Remote
	(const std::string& hostname, uint16_t port, const std::string& localIpAddress, bool use_IpV6, QObject* parent)
	: cExperimentState(parent), cExperimentStateRemoteInterface(/*parent*/), cLucidRgbPropertiesNetEncoder(255)
{
	mHostname = hostname;
	mPort = port;
...
bool cLucidVisionLabsRgbCameraExperimentState_Remote::initialize()
{
...
void cLucidVisionLabsRgbCameraExperimentState_Remote::cleanup()
{
	closeConnection();
	destroy();
}

bool cLucidVisionLabsRgbCameraExperimentState_Remote::recording()
{
	return false;
}

void cLucidVisionLabsRgbCameraExperimentState_Remote::decodeIncomingData(const void* pBuffer, std::size_t buf_length)
{
	cLucidRgbPropertiesNetDecoder::decode(pBuffer, buf_length);
}

int cLucidVisionLabsRgbCameraExperimentState_Remote::sendOutgoingData(const char* data, std::size_t len)
{
...
cLucidVisionLabsRgbCamera_Configure_Remote::cLucidVisionLabsRgbCamera_Configure_Remote(const std::string& hostname, uint16_t port,
	const std::string& localIpAddress, bool use_IpV6, QObject* parent)
:
	cLucidVisionLabsRgbCameraExperimentState_Remote(hostname, port, localIpAddress, use_IpV6, parent)
{
}

QString cLucidVisionLabsRgbCamera_Configure_Remote::getStatusStr()
{
	return "Configuring Lucid Vision Labs RGB camera...";
}

bool cLucidVisionLabsRgbCamera_Configure_Remote::configure(const nlohmann::json& stateDoc)
{
...
cExperimentState::eRESULT cLucidVisionLabsRgbCamera_Configure_Remote::finished()
{
...
cLucidVisionLabsRgbCamera_TakePhoto_Remote::cLucidVisionLabsRgbCamera_TakePhoto_Remote(const std::string& hostname, uint16_t port,
	const std::string& localIpAddress, bool use_IpV6, QObject* parent)
:
	cLucidVisionLabsRgbCameraExperimentState_Remote(hostname, port, localIpAddress, use_IpV6, parent)
{
...
QString cLucidVisionLabsRgbCamera_TakePhoto_Remote::getStatusStr()
{
	if (mUpdateView)
...
bool cLucidVisionLabsRgbCamera_TakePhoto_Remote::configure(const nlohmann::json& stateDoc)
{
	using namespace nlohmann;
...
cExperimentState::eRESULT cLucidVisionLabsRgbCamera_TakePhoto_Remote::finished()
{
	return mResult;
}
...
void cLucidVisionLabsRgbCamera_TakePhoto_Remote::onConnect()
{
//	sendQueryMode();
