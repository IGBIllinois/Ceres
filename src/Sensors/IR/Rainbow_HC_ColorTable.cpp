...
cRainbow_HC_ColorTable::cRainbow_HC_ColorTable() : cThermalColorTable(RAINBOW_HC_SIZE)
{}

cRainbow_HC_ColorTable::cRainbow_HC_ColorTable(double min, double max) : cThermalColorTable(min, max, RAINBOW_HC_SIZE)
{}

uint32_t cRainbow_HC_ColorTable::getColorValue(double v) const
{
    int index = getIndex(v);

    return RAINBOW_HC[index];
}
