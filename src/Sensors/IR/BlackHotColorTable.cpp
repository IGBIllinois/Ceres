...
cBlackHotColorTable::cBlackHotColorTable() : cThermalColorTable(BLACK_HOT_SIZE)
{}

cBlackHotColorTable::cBlackHotColorTable(double min, double max) : cThermalColorTable(min, max, BLACK_HOT_SIZE)
{}

eColorTable cBlackHotColorTable::getType() const 
{
    return eColorTable::BLACK_HOT; 
};

uint32_t cBlackHotColorTable::getColorValue(double v) const
{
    int index = getIndex(v);

    return BLACK_HOT[index];
}
