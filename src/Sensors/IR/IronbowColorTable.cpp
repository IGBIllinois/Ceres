...
cIronbowColorTable::cIronbowColorTable() : cThermalColorTable(IRONBOW_SIZE)
{}

cIronbowColorTable::cIronbowColorTable(double min, double max) : cThermalColorTable(min, max, IRONBOW_SIZE)
{}

uint32_t cIronbowColorTable::getColorValue(double v) const
{
    int index = getIndex(v);

    return IRONBOW[index];
}
