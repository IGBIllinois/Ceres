...
#if 0
std::string teledyne::to_string(rgb::eIMAGE_FORMAT format)
{
    switch (format)
    {
...
rgb::eIMAGE_FORMAT teledyne::to_image_format(const std::string& str)
{
    if (str == "mjpeg")
...
std::string teledyne::to_string(rgb::sImageSize_t size)
{
...
rgb::sImageSize_t teledyne::to_image_size(const std::string& str)
{
...
void teledyne::to_buffer(const QBitmap& img, cBitmapBuffer& out)
{
...
void teledyne::to_buffer(const QImage& img, cJpegBuffer& out)
{
    cImageWriteAdapter imageBuffer(&out);
...
void teledyne::to_buffer(const QImage& img, cMpegFrameBuffer& out)
{
    cImageWriteAdapter imageBuffer(&out);
...
void teledyne::to_image(const cBitmapBuffer& in, QBitmap& out)
{
...
void teledyne::to_image(const cJpegBuffer& in, QImage& out)
{
    cImageReadAdapter imageBuffer(&in);
...
void teledyne::to_image(const cMpegFrameBuffer& img, QImage& out)
{
