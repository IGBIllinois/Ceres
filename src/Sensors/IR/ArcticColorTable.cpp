...
cArcticColorTable::cArcticColorTable() : cThermalColorTable(ARCTIC_SIZE)
{}

cArcticColorTable::cArcticColorTable(double min, double max) : cThermalColorTable(min, max, ARCTIC_SIZE)
{}

uint32_t cArcticColorTable::getColorValue(double v) const
{
