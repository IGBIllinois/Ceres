...
cWhiteHotColorTable::cWhiteHotColorTable() : cThermalColorTable(WHITE_HOT_SIZE)
{}

cWhiteHotColorTable::cWhiteHotColorTable(double min, double max) : cThermalColorTable(min, max, WHITE_HOT_SIZE)
{}

uint32_t cWhiteHotColorTable::getColorValue(double v) const
{
    int index = getIndex(v);

    return WHITE_HOT[index];
}
