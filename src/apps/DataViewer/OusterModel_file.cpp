...
void cOusterModel_file::onLidarDataFormat(uint8_t device_id, ouster::lidar_data_format_2_t data)
{
    ...
    if (mDataFormat.pixels_per_column == 0)
    {
        mDataFormat.pixels_per_column = 128;
        mDataFormat.columns_per_packet = 16;
        mDataFormat.columns_per_frame = 1024;
        mDataFormat.pixel_shift_by_row = { 66, 45, 25, 4, 65, 45, 25, 5, 63,
        ...
        mDataFormat.column_window_min = 384;
        mDataFormat.column_window_max = 640;
        mDataFormat.udp_profile_lidar = "LEGACY";
        mDataFormat.udp_profile_imu = "LEGACY";
    }
