...
bool cScanPreviewWidget::captionLayout_t::operator==(const captionLayout_t& rhs) const
{
...
bool cScanPreviewWidget::screen_t::contains(int x, int y) const
{
...
void cScanPreviewWidget::experimentLayout_t::computeBounds()
{
...
bool cScanPreviewWidget::experimentLayout_t::operator==(const experimentLayout_t& rhs) const
{
...
bool cScanPreviewWidget::experimentLayout_t::operator==(const QString& label) const
{
	return caption.label == label;
}

cScanPreviewWidget::experimentLayout_t::operator bool() const
{
	return (height_mm != 0) && (width_mm != 0);
}

cScanPreviewWidget::cScanPreviewWidget(QWidget* parent)
:
	QWidget(parent)
{
...
cScanPreviewWidget::~cScanPreviewWidget()
{
}

bool cScanPreviewWidget::isDollyPositionVisible() const
{
	return mShowDollyPosition;
}

void cScanPreviewWidget::hideDollyPosition(bool hide)
{
	mShowDollyPosition = !hide;
}

void cScanPreviewWidget::showDollyPosition(bool show)
{
	mShowDollyPosition = show;
}

void cScanPreviewWidget::setDollyColor(uint8_t r, uint8_t g, uint8_t b, uint8_t a)
{
	mDollyColor.setRgb(r, g, b, a);
	mDollyPen.setColor(mDollyColor);
}

bool cScanPreviewWidget::isRecording() const
{
	return mIsRecording;
}

void cScanPreviewWidget::setRecording(bool recording)
{
...
void cScanPreviewWidget::clearRecordedPath()
{
	mMeasurementPaths.clear();
	mpActivePath = nullptr;
}

void cScanPreviewWidget::setMeasurementColor(uint8_t r, uint8_t g, uint8_t b, uint8_t a)
{
	mMeasurementColor.setRgb(r, g, b, a);
}

void cScanPreviewWidget::updateDollyPosition(uint32_t x, uint32_t y)
{
...
void cScanPreviewWidget::updateSecondaryDollyPosition(bool valid, uint32_t x, uint32_t y)
{
...
void cScanPreviewWidget::updateBounds(double minX, double maxX, double minY, double maxY)
{
	mMinX = minX;
	mMaxX = maxX;
	mMinY = minY;
...
void cScanPreviewWidget::loadLayout(const std::string& layout_filename)
{
...
void cScanPreviewWidget::saveLayout(const std::string& layout_filename)
{
	if (layout_filename.empty())
		return;
...
void cScanPreviewWidget::clearLayouts()
{
	mLayouts.clear();
...
void cScanPreviewWidget::addLayout(const experimentLayout_t& layout)
{
...
void cScanPreviewWidget::replaceLayout(const experimentLayout_t& original_layout, const experimentLayout_t& new_layout)
{
...
const std::vector<cScanPreviewWidget::experimentLayout_t>& cScanPreviewWidget::getLayouts() const
{
	return mLayouts;
}

std::tuple<int, int> cScanPreviewWidget::toSpiderCamCoordinates(int window_x, int window_y)
{
...
void cScanPreviewWidget::paintEvent(QPaintEvent* event)
{
...
void cScanPreviewWidget::drawLayout(QPainter& painter, double height, experimentLayout_t& layout)
{
	painter.save();
...
void cScanPreviewWidget::drawDollyMarker(QPainter& painter, double height,
...
void cScanPreviewWidget::drawPath(QPainter& painter, double height)
{
