...
class cCreateThermalExperimentFromPlotInfoDlg : public cCreateThermalExperimentDlg
{
	Q_OBJECT

public:
	cCreateThermalExperimentFromPlotInfoDlg(const QString& filename, QWidget* parent = nullptr);
	virtual ~cCreateThermalExperimentFromPlotInfoDlg();
