...
public:
	...
	enum class eBlockStatus { OK, BAD_CLASS_ID, BAD_MAJOR_VERSION, BAD_MINOR_VERSION, BAD_DATA_ID };
	eBlockStatus checkBlockId(const cBlockID blockID, uint32_t len = 0);
...
private:
	...
	std::ifstream::pos_type mStartOfData;
